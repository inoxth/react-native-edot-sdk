...
Provides a shared `@inox/react-native-edot-shared` package containing platform-agnostic utilities (e.g., ActiveViewContext) that other SDK packages depend on without requiring React Native.
