...
Provides a shared `@inox-edot/core` package containing platform-agnostic utilities (e.g., ActiveViewContext) that other SDK packages depend on without requiring React Native.
