...
Integrates with Wix React Native Navigation to automatically create view spans on screen appearances and maintain the ActiveViewContext, enabling network and error spans to be correlated to the current screen.
