...
Integrates with React Navigation to automatically create view spans on screen transitions and maintain the ActiveViewContext, enabling network and error spans to be correlated to the current screen.
