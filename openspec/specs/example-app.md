...
The monorepo SHALL include an `example/` directory containing a React Native app that imports `@inoxth/react-native-edot-sdk` from the workspace. The app SHALL initialize the SDK and display the session ID on screen.
