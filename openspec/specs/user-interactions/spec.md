...
Provides utilities for tracking user interaction events (taps, swipes, etc.) as telemetry actions, automatically correlating them with the current active view.
