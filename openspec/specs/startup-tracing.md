# Startup Tracing Specification

## Purpose
Trace application startup phases (native initialization, JS bundle load, first render) as OpenTelemetry spans to measure cold and warm start performance.
