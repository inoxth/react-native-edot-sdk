...
const config = {
  ...
  resolver: {
    extraNodeModules: {
      '@inoxth/react-native-edot-sdk': path.resolve(packages, 'react-native'),
      '@inoxth/react-native-edot-tracer-provider': path.resolve(packages, 'react-native-tracer-provider'),
    },
    nodeModulesPaths: [
