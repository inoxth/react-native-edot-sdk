...
module.exports = {
  ...
  apps: {
    'ios.release': { type: 'ios.app', binaryPath: 'ios/build/Build/Products/Release-iphonesimulator/EdotExample.app', build: 'xcodebuild -workspace ios/EdotExample.xcworkspace -scheme EdotExample -configuration Release -sdk iphonesimulator -derivedDataPath ios/build' },
