...
module.exports = {
  ...
  apps: {
    'ios.release': { type: 'ios.app', binaryPath: 'ios/build/Build/Products/Release-iphonesimulator/EdotExpoRouterExample.app', build: 'xcodebuild -workspace ios/EdotExpoRouterExample.xcworkspace -scheme EdotExpoRouterExample -configuration Release -sdk iphonesimulator -derivedDataPath ios/build' },
