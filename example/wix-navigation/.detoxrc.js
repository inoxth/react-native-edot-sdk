...
module.exports = {
  ...
  apps: {
    'ios.release': { type: 'ios.app', binaryPath: 'ios/build/Build/Products/Release-iphonesimulator/EdotWixNavExample.app', build: 'xcodebuild -workspace ios/EdotWixNavExample.xcworkspace -scheme EdotWixNavExample -configuration Release -sdk iphonesimulator -derivedDataPath ios/build' },
