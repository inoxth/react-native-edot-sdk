...
module.exports = {
  ...
  apps: {
    'ios.release': { type: 'ios.app', binaryPath: 'ios/build/Build/Products/Release-iphonesimulator/EdotReactNavExample.app', build: 'xcodebuild -workspace ios/EdotReactNavExample.xcworkspace -scheme EdotReactNavExample -configuration Release -sdk iphonesimulator -derivedDataPath ios/build' },
