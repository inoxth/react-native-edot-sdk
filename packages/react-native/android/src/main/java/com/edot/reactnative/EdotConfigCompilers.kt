...
/// Compiles JS-side configuration ([ignoreSpanNames], [ignoreLogPatterns])
/// into the typed exporter interceptors that `ElasticApmAgent.builder`
/// consumes. Mirrors the iOS helpers `compileSpanNamePredicates` and
